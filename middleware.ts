...
const protectedPrefixes = ['/dashboard', '/roadmap', '/calendar', '/templates', '/shared', '/settings'];
...
export const config = { matcher: ['/dashboard/:path*','/roadmap/:path*','/calendar/:path*','/templates/:path*','/shared/:path*','/settings/:path*','/auth/:path*'] };
